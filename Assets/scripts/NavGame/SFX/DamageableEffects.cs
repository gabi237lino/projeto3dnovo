...
namespace NavGame.Effects 
{
    ...
    public class DamageableEffects : SFXController 
    {
        ...
        {
            PlayEffects(strikePoint, damageSound, damageEffect, Quaternion.identity);
        } 
        protected virtual void OnDied()
        {
            PlayEffects(transform.position, dieSond, dieEffect, Quaternion.identity);
        }
    }
}